...
<section class="kolophon">
  ...
  <p>Ein Vorgang b&uuml;ndelt alles zum selben Vorhaben — ein
  Bauleitplanverfahren l&auml;uft &uuml;ber mehrere Vorlagen mit eigener Nummer.
  Geb&uuml;ndelt wird &uuml;ber den im Titel genannten Namen des Vorhabens, sonst
  &uuml;ber die Vorlagennummer.</p>
  <p>Die Kette zeigt jede Station mit Datum, Gremium und Abstimmungsergebnis.
  <span class="mono">25 : 0 : 1</span> hei&szlig;t Ja : Nein : Enthaltungen; zwei
  Ergebnisse an einer Station bedeuten, dass zuerst &uuml;ber einen
  &Auml;nderungsantrag abgestimmt wurde.</p>
  ...
  <h3>Zu den Treffern</h3>
  <p>Oben steht, was den Suchbegriff in &Uuml;berschrift oder Vorlagennummer
  tr&auml;gt; alles Weitere ist mit <i>Treffer im Text</i> markiert.</p>
  <p>Unter jeder Station steht der <b>beschlossene Wortlaut</b>. Angezeigt werden
  rund 340 Zeichen, <b>durchsucht wird der vollst&auml;ndige Beschluss</b>; liegt
  der Treffer hinter der K&uuml;rzung, erscheint der ganze Text. Anh&auml;ngende
  Unterlagen sind verlinkt.</p>
  <p><b>Betr&auml;ge sind Fundstellen, keine Kostenangaben:</b> der gr&ouml;&szlig;te
  im Beschlusstext genannte Betrag ab 250.000 &euro;. Das kann der Preis eines
  Vorhabens sein, ebenso ein Haushaltsansatz — bei einer Haushaltssatzung der
  Ertrag der ganzen Stadt.</p>
  <p>Gremien ohne ver&ouml;ffentlichte Tagesordnung — die Ortschaftsr&auml;te —
  fehlen hier vollst&auml;ndig, weil es von ihnen nichts zu indizieren gibt.</p>
